...
type Transaction struct {
	...
	// BTC specific fields.
	Outputs      []AddressAndAmount `json:"outputs"`
...
func (handlers *Handlers) getTxInfoJSON(txInfo *accounts.TransactionData, detail bool) Transaction {
	...
	txInfoJSON := Transaction{
		...
		Type: map[accounts.TxType]string{
			...
			accounts.TxTypeCollaborativeReceive: "collaborative_receive",
			accounts.TxTypeCollaborativeSend:    "collaborative_send",
		}[txInfo.Type],
